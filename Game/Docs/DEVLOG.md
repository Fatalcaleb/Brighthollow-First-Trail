...
The temporary doorway implementation required repeated trigger-size and foot-offset patches. It was replaced with actual Godot physics areas and named spawn points. Building collision is now split around visible door openings so the physical map and visual map agree.
